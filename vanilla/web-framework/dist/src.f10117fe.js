    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        var _eventKey$split = eventKey.split(":"),
            ...
            tag = _eventKey$split2[1];

        fragment.querySelectorAll(tag).forEach(function (e) {
          return e.addEventListener(event, eventsMap[eventKey]);
        });
      };
...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    ...
    value: function template() {
      return "\n        <div>\n            <h1>User Detail</h1>\n            <div>User Name: ".concat(this.instance.get("name"), "</div>\n            <div>User Age: ").concat(this.instance.get("age"), "</div>\n        </div>\n        ");
    }
  }]);
...
var UserList = /*#__PURE__*/function (_CollectionView_1$Col) {
  ...
  _createClass(UserList, [{
    key: "renderItem",
    value: function renderItem(instance, itemParent) {
      new UserShow_1.UserShow(itemParent, instance).render();
    }
  }]);
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/models/Events.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Events() {
    ...
    this.trigger = function (event) {
      ...
      handlers.forEach(function (callFn) {
        return callFn();
      });
    };
  }
...
},{"axios":"node_modules/axios/index.js","./Events":"src/models/Events.ts"}],"src/models/Model.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Model(attributes, io, events) {
    this.attributes = attributes;
    this.io = io;
    this.events = events; //brittle code

    this.on = this.events.on; //Property assignments are handled before function and object assignments.

    this.trigger = this.events.trigger; //Only use this pass-though approach when certain that the properties are already initialize prior to the code

    this.get = this.attributes.get; //Or when the properties are created with access modifiers in the constructor's args list (args), which initializes them prior.
  } //   get on() {
  ...
  Model.prototype.set = function (attribute) {
  ...
  Model.prototype.fetch = function () {
    ...
    this.io.fetch(id).then(function (res) {
  ...
  Model.prototype.save = function () {
    ...
    this.io.save(this.attributes.getAll()).then(function (res) {
...
function () {
  ...
  Attributes.prototype.set = function (attribute) {
...
},{}],"src/models/ApiIO.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function ApiIO(rootUrl) {
    this.rootUrl = rootUrl;
  }

  ApiIO.prototype.fetch = function (id) {
    return axios_1.default.get("".concat(this.rootUrl, "/").concat(id));
  };

  ApiIO.prototype.save = function (data) {
    var id = data.id;
    if (id) return axios_1.default.put("".concat(this.rootUrl, "/").concat(id), data);else return axios_1.default.post(this.rootUrl, data);
  };
...
function (_super) {
  ...
  User.build = function (attributes) {
    return new User(new Attributes_1.Attributes(attributes), new ApiIO_1.ApiIO(rootUrl), new Events_1.Events());
  };
  ...
  User.prototype.setRandomAge = function () {
    var age = Math.round(Math.random() * 89);
    this.set({
      age: age
    });
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiIO":"src/models/ApiIO.ts","./Events":"src/models/Events.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
